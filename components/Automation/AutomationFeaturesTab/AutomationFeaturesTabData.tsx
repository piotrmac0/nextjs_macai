...
const featuresTabData: FeatureTab[] = [
  {
    ...
    desc1: `Start your project with solid foundations by utilizing my audit and strategy services enhanced with analysis of automation possibilities and AI implementation- I examine your current systems and processes to identify how AI technology and automation can benefit your business.`,
  ...
  },
  {
    ...
    desc1: `Transform your ideas into innovative solutions with our project approach that leverages artificial intelligence to create intuitive and intelligent interfaces. Our projects are user-centric, ensuring not only aesthetics but also functionality through automation and personalization.`,
  ...
  },
  {
    ...
    desc1: `Maximize the effectiveness of your online efforts through advanced analytics and optimizations based on data from CRM systems. We focus on delivering insights that help optimize customer paths, personalize offerings, and increase conversions.`,
